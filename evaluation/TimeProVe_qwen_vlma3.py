#!/usr/bin/env python3
"""
Interpretable VLM pipeline with stage-1 temporal proposals.
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Use only the single highest-relevance window (one clip + QA); skip confidence model and multi-window iteration.",
    )
    parser.add_argument(
